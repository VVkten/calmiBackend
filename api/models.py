...
class User(AbstractUser):
    ...
    photo = models.CharField(max_length=255, blank=True, null=True)  # зберігаємо шлях як строку
...
class UserProfile(models.Model):
    ...
    saved_exercises = models.ManyToManyField(Exercise, blank=True)
    saved_tests = models.ManyToManyField(Test, blank=True)

    def __str__(self):
        return f"Saved {self.user}"